-- Script para inserir todas as 20 rotas conforme especificação
...
-- 2. Inserir todas as rotas de SAÍDA
...
SELECT 
    'ROTAS INSERIDAS' as status,
    COUNT(*) as total_rotas
FROM routes 
WHERE is_active = true;

-- 4. Mostrar todas as rotas organizadas
SELECT 
    CASE 
